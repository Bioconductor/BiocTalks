...
\begin{frame}{\Bioconductor{}}
  ...
  \begin{itemize}
  \item Started 2002
  \item 1473 \R{} packages -- developed by `us' and user-contributed.
  \end{itemize}
...
\begin{frame}{Cloud computing}
  ...
  \item Exploit cloud services, e.g., BigQuery.
  ...
  \item Federated data access.
  \end{itemize}
\end{frame}

\begin{frame}{Events}
  \begin{itemize}
  \item \emph{CSAMA} (training), Brixen / Bressanone, Italy, 8 - 13
    July.
  \item \emph{Bioc2018} Toronto, Canada, 25 - 27 July.
  \end{itemize}
\end{frame}
